...
function HomePage({ navigate }) {
  // Daily overview: GPA · Messages · Assignments · Alerts
  const overviewTiles = [
    ...
    { icon:'📋', val:STUDENT.assignments.filter(a=>a.status==='pending').length||'',   label:'Assignments', page:'grades',   color:T.teal      },
    { icon:'🔔', val:STUDENT.alerts.length||'',                                        label:'Alerts',      page:'alerts',   color:T.amber     },
  ]
        ...
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center' }}>
          ...
          <div style={{ display:'flex', gap:8 }}>
            {STUDENT.threads.some(t=>t.unread) && (
              <div style={{ background:T.red, borderRadius:999, padding:'3px 8px', fontSize:10, fontWeight:700, color:'#fff', alignSelf:'center' }}>

...
const T = { primary:'#461D7C', secondary:'#FDD023', bg:'#080012', card:'#120520', inner:'#1c0830', text:'#ede8f5', muted:'#7060a0', border:'#3a1560', hint:'#2a0e50', green:'#22c97a', blue:'#FDD023', red:'#f04a4a', amber:'#FDD023', purple:'#9b6ef5', header:'linear-gradient(135deg,#461D7C,#2d1254)' }
...
function BottomNav({ active, onSelect }) {
  ...
  return (
    <div style={{ position:'fixed', bottom:0, left:0, right:0, zIndex:100, background:'rgba(8,0,18,0.97)', borderTop:`1px solid ${T.border}`, padding:'6px 0 max(16px,env(safe-area-inset-bottom))', display:'grid', gridTemplateColumns:`repeat(${items.length},1fr)` }}>
      {items.map(item => (
    ...
    <>
      <div style={{ minHeight:'100vh', background:T.bg, color:T.text, fontFamily:'Inter, Arial, sans-serif', paddingBottom:80 }}>
        ...
        <div style={{ padding:'16px 10px' }}>
          ...
          <button onClick={() => setCompose(true)} style={{ width:'100%', background:T.primary, color:'#fff', border:'none', borderRadius:14, padding:'12px', fontSize:14, fontWeight:700, cursor:'pointer', marginTop:8 }}>

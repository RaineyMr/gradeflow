...
// ─── Desktop Login (two-column with orange top bar) ───────────────────────────
      ...
      <div style={{ background:BRAND.gradient, flexShrink:0, display:'flex', alignItems:'center', justifyContent:'space-between', padding:'0 44px', height:54 }}>
        <div style={{ display:'flex', alignItems:'center', gap:16 }}>
          ...
          <span style={{ fontSize:13, color:'rgba(255,255,255,0.88)', fontWeight:500 }}>
            The all-in-one platform for teachers, students, parents &amp; admins
          </span>
        </div>
      ...
      <div style={{ flex:1, display:'flex' }}>
        ...
        <div style={{ flex:'0 0 52%', background:'linear-gradient(160deg,#0a0f1e 0%,#060810 60%)', borderRight:`1px solid ${BRAND.border}`, display:'flex', flexDirection:'column', justifyContent:'space-between', padding:'44px 56px' }}>
          <div>
            ...
            <p style={{ color:BRAND.muted, fontSize:15, lineHeight:1.7, maxWidth:400, margin:'0 0 40px' }}>
              One platform for teachers, students, parents, and admins — built around your school's identity.
            </p>
          </div>

          {/* Feature grid — all 6, 2 columns */}
          ...
          <p style={{ fontSize:12, color:BRAND.muted, marginTop:28 }}>Each demo uses a real school's branding &amp; colors throughout.</p>
        </div>
        ...
        <div style={{ flex:1, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:'48px 40px', overflowY:'auto' }}>
          <div style={{ width:'100%', maxWidth:440 }}>
            ...
            <p style={{ fontSize:13, color:BRAND.muted, margin:'0 0 24px' }}>Select your role, then sign in or use a quick-demo button.</p>
...
// ─── Root: detects viewport, renders correct layout ───────────────────────────

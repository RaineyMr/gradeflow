...
const DEMO_GRADES = [
  ...
  { studentId: 2, assignmentId: 1, score: 58, max: 100, aiGraded: true, aiConfidence: 'low' },
...
const DEMO_MESSAGES = [
  { id: 1, studentId: 2, studentName: 'Marcus Thompson', subject: 'Math', trigger: 'Failed 58%', status: 'pending', tone: 'Warm & Friendly', dayOld: true, draft: "Dear Parent, Marcus received 58% on his Math assessment. I'd love to connect this week to discuss support options.", positiveDraft: "Dear Parent, I wanted to share that Marcus has been showing real effort in Math class. Let's connect to build on that momentum!" },
  { id: 2, studentId: 9, studentName: 'Zoe Anderson', subject: 'Science', trigger: 'Grade dropped 12 pts', status: 'pending', tone: 'Professional', dayOld: true, draft: "Dear Parent, I noticed Zoe's Science grade has dropped 12 points recently. I'd like to schedule a brief call to discuss how we can help.", positiveDraft: "Dear Parent, Zoe has shown great curiosity in Science. I'd love to share some ways to keep that momentum going at home." },
]

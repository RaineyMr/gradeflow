...
const DEMO_LESSONS = {
  1: [
    ...
    { id: 'math-18', classId: 1, dayLabel: 'Wed · Apr 23', title: 'Unit 4 · Comparing Fractions', duration: '45 min', pages: 'Pages 86-89', objective: 'Students will compare fractions with unlike denominators.', warmup: ['Fraction comparison', 'Benchmark fractions'], activities: ['Common denominator strategy', 'Visual comparison', 'Number line ordering'], materials: ['Fraction circles', 'Number lines'], homework: 'Workbook page 90, problems 1-8', status: 'pending', pdf: 'https://www.mathworksheetsland.com/fractions/comparing-fractions/worksheets/' },
    { id: 'math-19', classId: 1, dayLabel: 'Thu · Apr 24', title: 'Unit 4 · Adding & Subtracting Fractions', duration: '45 min', pages: 'Pages 90-93', objective: 'Students will add and subtract fractions with unlike denominators.', warmup: ['Like denominator review', 'Common denominator practice'], activities: ['LCM strategy', 'Visual modeling', 'Algorithm practice'], materials: ['Fraction strips', 'LCM charts'], homework: 'Workbook page 94, problems 1-10', status: 'pending', pdf: 'https://www.mathworksheetsland.com/fractions/adding-fractions/worksheets/' },
    { id: 'math-20', classId: 1, dayLabel: 'Fri · Apr 25', title: 'Unit 4 · Fractions Quiz', duration: '45 min', pages: 'Pages 95-97', objective: 'Students will demonstrate fraction concept mastery.', warmup: ['Comprehensive review', 'Strategy selection'], activities: ['Fractions quiz', 'Extension activities'], materials: ['Quiz sheets', 'Fraction manipulatives'], homework: 'No homework - quiz day', status: 'pending', pdf: 'https://www.math-aids.com/Fractions/Test/Fractions-Test-Worksheet.pdf' },
  ],
  2: [

...
const DEMO_LESSONS = {
  1: [
    ...
    { id: 'math-1', date: '2026-04-01', classId: 1, dayLabel: 'Mon · Apr 1', date: '2026-04-01', title: 'Unit 1 · Place Value to Millions', duration: '45 min', pages: 'Pages 12-15', objective: 'Students will read, write, and compare numbers to millions place.', warmup: ['Number of the day: 2,457,891', 'Place value review'], activities: ['Place value chart modeling', 'Expanded form practice', 'Partner comparison game'], materials: ['Place value charts', 'Base-10 blocks', 'Whiteboards'], homework: 'Workbook page 16, problems 1-12', status: 'done', pdf: 'https://www.commoncoresheets.com/Math/Content/5/NBT/1/Download/5NBT-A1.pdf' },

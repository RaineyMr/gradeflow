...
export default function App() {
  ...
  const navItems = [
    ...
    { id: 'classFeed', icon: '📢', label: 'Feed', action: () => goTo('classFeed') },
  ]
  ...
  const activeNav = ['gradebook', 'studentProfile'].includes(activeScreen) ? 'gradebook'
    : activeScreen
            ...
            <div className="relative">
              ...
              {menuOpen && (
                <>
                  ...
                  <div className="absolute right-0 top-full mt-2 w-52 rounded-card border border-elevated overflow-hidden z-50 animate-slide-up" style={{ background: '#161923' }}>
                    {[
